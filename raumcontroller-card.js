...
class RaumcontrollerCard extends HTMLElement {
    ...
    render() {
      ...
      <ha-card class="rc-card">
        ...
        <div class="rc-body">
          ...
          <div class="rc-grid">
            ${this.renderTile(this._config.govee_light_label || "Govee", this._config.govee_light, "💡")}
            ${this.renderTile(this._config.knx_light_label || "KNX", this._config.knx_light, "💡")}
            ${this._config.extra_light_1
            ? this.renderTile(this._config.extra_light_1_label || "Licht 1", this._config.extra_light_1, "💡")
            : ""}
            ${this._config.extra_light_2
            ? this.renderTile(this._config.extra_light_2_label || "Licht 2", this._config.extra_light_2, "💡")
            : ""}
            ${this._config.extra_light_3
            ? this.renderTile(this._config.extra_light_3_label || "Licht 3", this._config.extra_light_3, "💡")
            : ""}
            ${this.renderTile(this._config.cover_entity_label || "Jalousien", this._config.cover_entity, `<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#a78bfa" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="4" rx="1"/><rect x="3" y="9" width="18" height="4" rx="1"/><rect x="3" y="15" width="18" height="4" rx="1"/><line x1="12" y1="19" x2="12" y2="22"/></svg>`)}
            ${this._config.extra_cover_1
            ? this.renderTile(this._config.extra_cover_1_label || "Jalousie 1", this._config.extra_cover_1, `<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#a78bfa" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="3" rx="1"/><rect x="3" y="8" width="18" height="3" rx="1"/><rect x="3" y="13" width="18" height="3" rx="1"/><line x1="7" y1="18" x2="7" y2="21"/><line x1="17" y1="18" x2="17" y2="21"/></svg>`)
            : ""}
            ${this._config.extra_cover_2
            ? this.renderTile(this._config.extra_cover_2_label || "Jalousie 2", this._config.extra_cover_2, `<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#a78bfa" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="3" rx="1"/><rect x="3" y="8" width="18" height="3" rx="1"/><rect x="3" y="13" width="18" height="3" rx="1"/><line x1="7" y1="18" x2="7" y2="21"/><line x1="17" y1="18" x2="17" y2="21"/></svg>`)
            : ""}
            ${this._config.extra_cover_3
            ? this.renderTile(this._config.extra_cover_3_label || "Jalousie 3", this._config.extra_cover_3, `<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#a78bfa" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="3" rx="1"/><rect x="3" y="8" width="18" height="3" rx="1"/><rect x="3" y="13" width="18" height="3" rx="1"/><line x1="7" y1="18" x2="7" y2="21"/><line x1="17" y1="18" x2="17" y2="21"/></svg>`)
            : ""}
    ...
    renderTile(label, entityId, icon) {
        ...
        const displayName = label || entity?.attributes?.friendly_name || "";
        return `
...
const LABELS = {
    ...
    govee_light_label: "Name Govee",
    knx_light: "KNX Leuchte",
    knx_light_label: "Name KNX",
    extra_light_1: "Zusätzliches Licht 1",
    extra_light_1_label: "Name zusätzliches Licht 1",
    extra_light_2: "Zusätzliches Licht 2",
    extra_light_2_label: "Name zusätzliches Licht 2",
    extra_light_3: "Zusätzliches Licht 3",
    extra_light_3_label: "Name zusätzliches Licht 3",
    cover_entity: "Jalousien",
    cover_entity_label: "Name Jalousien",
    extra_cover_1: "Zusätzliche Jalousie 1",
    extra_cover_1_label: "Name zusätzliche Jalousie 1",
    extra_cover_2: "Zusätzliche Jalousie 2",
    extra_cover_2_label: "Name zusätzliche Jalousie 2",
    extra_cover_3: "Zusätzliche Jalousie 3",
    extra_cover_3_label: "Name zusätzliche Jalousie 3",
